...
public class DownloadsDB {
    private static final String DATABASE_NAME = "DownloadsDB1";
    ...
    int mStatus = -1;
    int mFlags;
    static public boolean UseCDN(){
        return ismUseCND();
    }

    public ArrayList<DownloadInfo> waitingDownloads = new ArrayList<DownloadInfo>();

    private static boolean mUseCND;

    public void AddNewDownload(DownloadInfo info){
        waitingDownloads.add(info);
    }
    ...
    public static boolean ismUseCND() {
        return true;
    }
    ...
    private static final String[] DC_PROJECTION = {
            ...
            DownloadColumns.INDEX, DownloadColumns.MD5
    };
    ...
    private static final int MD5 = 12;
    /**
    ...
    public boolean updateDownload(DownloadInfo di) {
        ...
        cv.put(DownloadColumns.MD5,di.mFileMd5);
    ...
    public void setDownloadInfoFromCursor(DownloadInfo di, Cursor cur) {
        ...
        di.mFileMd5 = cur.getString(MD5);
    }

    public DownloadInfo getDownloadInfoFromCursor(Cursor cur) {
        DownloadInfo di = new DownloadInfo(cur.getInt(INDEX_IDX),
                cur.getString(FILENAME_IDX),cur.getString(URI_IDX),cur.getLong(TOTALBYTES_IDX),cur.getString(MD5));
        setDownloadInfoFromCursor(di, cur);
        return di;
    }
