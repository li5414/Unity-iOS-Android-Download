...
public class Constants {    
    ...
    public static final String TAG = SDKManager.GetInstance().LogTag + "_LVLDL";

    /**
     * pkg name
     */
    public static final String PKG_NAME = "ro.pkg";
     ...
     */
    public static final long WATCHDOG_WAKE_TIMER = 3*1000;
